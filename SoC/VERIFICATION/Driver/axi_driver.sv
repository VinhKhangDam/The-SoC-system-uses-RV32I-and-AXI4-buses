class axi_driver extends uvm_driver #(axi_transaction);
	...
	task drive_write(axi_transaction tr);
		...
		`uvm_info("DRV", $sformatf("Write Done: Addr=%h Data=%h Prot=%b",
			tr.addr, tr.data, tr.awprot), UVM_MEDIUM)
	endtask
	...
	task drive_read(axi_transaction tr);
		...
		`uvm_info("DRV", $sformatf("Read Done: Addr=%h Data=%h Prot=%b",
			tr.addr, tr.data, tr.arprot), UVM_MEDIUM)
	endtask
endclass