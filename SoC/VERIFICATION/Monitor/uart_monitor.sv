  ...
  task run_phase(uvm_phase phase);
    ...
    forever begin
      ...
      if (vif.mon_cb.wvalid && vif.mon_cb.wready) begin
        ...
        `uvm_info("UART_MON_WR", $sformatf("WRITE : Addr=%h Data=%h Prot=%b Strb=%b", tr.addr,
                                           tr.data, tr.awprot, tr.wstrb), UVM_LOW)
        ap.write(tr);
      end
      ...
      if (vif.mon_cb.rvalid && vif.mon_cb.rready) begin
        ...
        `uvm_info("UART_MON_RD", $sformatf("READ : Addr = %h Data = %h Prot = %b Resp = %b",
                                           tr.addr, tr.data, tr.arprot, tr.resp), UVM_LOW)
        ap.write(tr);
      end
    end
  endtask
