class timer_sequence extends uvm_sequence #(timer_transaction);
  ...
  task body();
    ...
    repeat (20) read_reg(32'h2000_0008, 3'b010);
    ...
    repeat (300) begin
      ...
      assert (tr.randomize() with {
        ...
        if (addr == 32'h2000_0000) data inside {32'h0, 32'h1, 32'h2, 32'h3};
        if (addr == 32'h2000_0004) data inside {32'd0, [32'd1 : 32'd20], 32'd100, 32'hffff_ffff};
        wstrb == 4'hf;
      });
      finish_item(tr);
    end
