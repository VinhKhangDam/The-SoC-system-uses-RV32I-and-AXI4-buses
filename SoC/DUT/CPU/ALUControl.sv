  ...
  always_comb begin
    case (ALUOp)
      ...
      2'b10: begin  // R-type hoặc I-type ALU
        case (funct3)
          3'b000:
          if (opcode == 7'b0110011 && funct7b) ALUControl = 4'b0110;  // Subtract (sub)
          else ALUControl = 4'b0010;  // Add (add, addi)
          ...
          3'b101:
          if (funct7b) ALUControl = 4'b1001;  // SRA, SRAI (Dịch phải số học)
          else ALUControl = 4'b0101;  // SRL, SRLI (Dịch phải logic)
