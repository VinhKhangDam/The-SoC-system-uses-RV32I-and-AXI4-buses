...
HD_PWD='/home/khang/Documents/SystemVerilog/SoC-RV32I/Vivado/soc/soc.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AXI_Master.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AXI_Master.tcl
