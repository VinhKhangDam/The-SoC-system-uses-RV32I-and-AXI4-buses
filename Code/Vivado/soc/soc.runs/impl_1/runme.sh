...
HD_PWD='/home/khang/Documents/SystemVerilog/SoC-RV32I/Vivado/soc/soc.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log AXI_Master.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source AXI_Master.tcl -notrace
